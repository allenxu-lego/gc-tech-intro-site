# cicd-workflow - Task 3

Execute task 3 for the cicd-workflow specification.

## Task Description
Create FlowchartContext provider

## Code Reuse
**Leverage existing code**: `src/components/SidebarProvider.tsx` (context pattern)
...
## Usage
```
/Task:3-cicd-workflow
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create FlowchartContext provider"

```
Use the @spec-task-executor agent to implement task 3: "Create FlowchartContext provider" for the cicd-workflow specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Create FlowchartContext provider
- Leverage: `src/components/SidebarProvider.tsx` (context pattern)
- Requirements: AC-5, AC-7

## Instructions
- Implement ONLY task 3: "Create FlowchartContext provider"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks cicd-workflow 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks cicd-workflow 3 --mode complete
```
