# cicd-workflow - Task 5

Execute task 5 for the cicd-workflow specification.

## Task Description
Create FlowchartNode component

## Code Reuse
**Leverage existing code**: `src/components/NavItem.tsx` (active/hover styling pattern)

## Requirements Reference
**Requirements**: AC-4, AC-6

## Usage
```
/Task:5-cicd-workflow
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create FlowchartNode component"

```
Use the @spec-task-executor agent to implement task 5: "Create FlowchartNode component" for the cicd-workflow specification and include all the below context.
...
## Task Details
- Task ID: 5
- Description: Create FlowchartNode component
- Leverage: `src/components/NavItem.tsx` (active/hover styling pattern)
- Requirements: AC-4, AC-6

## Instructions
- Implement ONLY task 5: "Create FlowchartNode component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks cicd-workflow 5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks cicd-workflow 5 --mode complete
```
