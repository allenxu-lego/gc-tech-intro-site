# cicd-workflow - Task 7

Execute task 7 for the cicd-workflow specification.

## Task Description
Assemble main Flowchart component

## Code Reuse
**Leverage existing code**: `src/lib/constants.ts` (BRAND.colors.primary)

## Requirements Reference
**Requirements**: AC-2, AC-3, AC-4, AC-6

## Usage
```
/Task:7-cicd-workflow
```

## Instructions

Execute with @spec-task-executor agent the following task: "Assemble main Flowchart component"

```
Use the @spec-task-executor agent to implement task 7: "Assemble main Flowchart component" for the cicd-workflow specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Assemble main Flowchart component
- Leverage: `src/lib/constants.ts` (BRAND.colors.primary)
- Requirements: AC-2, AC-3, AC-4, AC-6

## Instructions
- Implement ONLY task 7: "Assemble main Flowchart component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks cicd-workflow 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks cicd-workflow 7 --mode complete
```
